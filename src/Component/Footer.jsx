...
const Footer = () => {
  return (
    <footer className="relative p-6 mt-10 text-white">
      <div className="container mx-auto text-center">
        ...
        © 2024 <span><a href="https://shanuk.me/" className=' text-[#49e3f5] font-semibold'>AshanKavi</a>.</span> All rights reserved.
      </p>
      </div>
    </footer>
  );
